...
-- Add level column to organizations
ALTER TABLE public.organizations ADD COLUMN IF NOT EXISTS level integer NOT NULL DEFAULT 1;

-- Update the ad limit check to respect org level
